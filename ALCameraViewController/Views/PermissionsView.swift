...
internal class PermissionsView: UIView {
    ...
    func configureInView(view: UIView, title: String, descriptiom: String, completion: ButtonAction) {
        ...
        closeButton.setImage(UIImage(named: "retakeButton", inBundle: CameraGlobals.shared.bundle, compatibleWithTraitCollection: nil), forState: UIControlState())
    ...
    func commonInit() {
        ...
        settingsButton.setTitle(localizedString("permissions.settings"), forState: UIControlState())
        settingsButton.setTitleColor(UIColor.whiteColor(), forState: UIControlState())
